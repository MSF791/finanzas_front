import { DeletePresupuesto } from "../../api/presupuesto.api";
import toast from "react-hot-toast";

export function ModalDeletePresupuesto({
  isOpen,
  onClose,
  id,
  logueado,
        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:max-w-lg">
          <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            ...
            <p className="text-sm text-gray-500">
              ¿Estás seguro de que deseas eliminar este Presupuesto? Esta acción
